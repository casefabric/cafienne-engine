...
//
            ...
            //
            testCase.assertStepFails(new SaveTaskOutput(pete, caseInstanceId, adminTaskId, taskOutputDecisionCanceled.cloneValueNode()), "You do not have permission to perform this operation");

            //
            // CompleteTask - pete should not be able to complete AdminTask (lack of appropriate role)
            //
            testCase.assertStepFails(new CompleteHumanTask(pete, caseInstanceId, adminTaskId, taskOutputDecisionCanceled.cloneValueNode()), "You do not have permission to perform this operation");
            ...
            //
            testCase.assertStepFails(new AssignTask(pete, caseInstanceId, taskId, gimy), "You do not have permission to perform this operation");

            //
            // AssignTask - Only Unassigned task can be assigned to a user
            //
            testCase.addStep(new AssignTask(tom, caseInstanceId, taskId, pete));
            ...
            //
            testCase.assertStepFails(new DelegateTask(gimy, caseInstanceId, taskId, pete), "You do not have permission to perform this operation");

            //
            // CompleteTask - Outside of case team members cannot take actions on task
            //
            testCase.assertStepFails(new CompleteHumanTask(notInTeam, caseInstanceId, taskId, taskOutputDecisionCanceled.cloneValueNode()), "User not-in-team is not part of the case team");
...
//            testCase.assertStepFails(new ClaimTask(pete, caseInstanceId, taskId), "Cannot be done because the task is in Assigned state, but should be in any of [Unassigned] state");
            ...
            // AssignTask - Only Unassigned task can be assigned to a user
            //
            testCase.assertStepFails(new AssignTask(pete, caseInstanceId, taskId, gimy), "does not have the case role");

            //
            // ValidateTaskOutput - Only the current assignee should be able to validate task output
            //
            testCase.assertStepFails(new ValidateTaskOutput(gimy, caseInstanceId, taskId, taskOutputDecisionCanceled.cloneValueNode()), "You do not have permission to perform this operation");

            //
            // SaveTaskOutput - Only the current assignee should be able to save task data
            //
            testCase.assertStepFails(new SaveTaskOutput(gimy, caseInstanceId, taskId, taskOutputDecisionCanceled.cloneValueNode()), "You do not have permission to perform this operation");
...
//                CaseAssertion taskAssertion = new CaseAssertion(action);
            ...
            //
            testCase.assertStepFails(new RevokeTask(gimy, caseInstanceId, taskId), "You do not have permission to perform this operation");
