...
package org.cafienne.userregistration.tenant.actorapi.event;
...
/**
 * Event that is published after an {@link org.cafienne.userregistration.tenant.actorapi.command.TenantCommand} has been fully handled by a {@link TenantActor} instance.
