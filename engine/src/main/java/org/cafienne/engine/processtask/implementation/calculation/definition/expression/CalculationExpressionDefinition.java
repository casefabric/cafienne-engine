...
package org.cafienne.engine.processtask.implementation.calculation.definition.expression;
...
import org.cafienne.engine.cmmn.expression.spel.ExpressionEvaluator;
...
public class CalculationExpressionDefinition extends CMMNElementDefinition {
    ...
    public CalculationExpressionDefinition(Element element, ModelDefinition processDefinition, CMMNElementDefinition parentElement) {
        ...
        this.expression = parseExpressionString(null, false, "");
