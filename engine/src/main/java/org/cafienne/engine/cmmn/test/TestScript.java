...
import org.cafienne.engine.cmmn.definition.InvalidDefinitionException;
import org.cafienne.engine.cmmn.repository.DefinitionProvider;
import org.cafienne.engine.cmmn.repository.MissingDefinitionException;
import org.cafienne.engine.cmmn.test.assertions.CaseAssertion;
import org.cafienne.engine.cmmn.test.assertions.FailureAssertion;
...
public class TestScript {
    ...
    public TestScript(String testName) {
        this(testName, CaseSystem.apply(ActorSystem.create(testName)));
    }
