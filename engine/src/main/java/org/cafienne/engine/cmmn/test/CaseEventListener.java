...
import org.cafienne.engine.cmmn.actorapi.event.plan.task.TaskEvent;
import org.cafienne.engine.cmmn.actorapi.event.plan.task.TaskInputFilled;
...
public class CaseEventListener {
    ...
    private final CaseEngineGateway caseMessageRouter; // proxy to the case system
