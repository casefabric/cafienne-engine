...
package org.cafienne.engine.cmmn.expression.spel.api;

import org.cafienne.engine.cmmn.expression.spel.api.cmmn.plan.CaseAPI;
import org.cafienne.engine.cmmn.expression.spel.api.cmmn.plan.PlanItemAPI;
import org.cafienne.engine.cmmn.expression.spel.api.cmmn.team.CurrentMemberAPI;
...
public abstract class CaseRootObject extends APIRootObject<Case> {
    ...
    protected CaseRootObject(Case model) {
        super(model, new CurrentMemberAPI(model));
