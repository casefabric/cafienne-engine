...
package org.cafienne.engine.processtask.implementation.smtp;
...
import org.cafienne.engine.processtask.implementation.mail.MailDefinition;
...
public class SMTPCallDefinition extends MailDefinition {
    ...
    public Properties getMailProperties(ProcessTaskActor processTaskActor) {
        logger.warn("Using deprecated class to send emails. Please use org.cafienne.engine.processtask.implementation.mail.MailDefinition");
